...
{
    AssetCompilationPass::sToken pass_token;
...
struct AssetCompilationThread
{
    ...
    inline void push_asset_compilation_pass(const AssetCompilationPass::sToken p_asset_compilation_pass_token, const AssetCompilationPass& p_asset_compilation_pass)
    {
...
using t_AssetCompilationPassWidgets = Pool<AssetCompilationPassWidget>;
using AssetCompilationPassWidget_Token = t_AssetCompilationPassWidgets::sToken;
using AssetCompilationPassWidget_TokenValue = t_AssetCompilationPassWidgets::sTokenValue;

struct AssetCompilerWidgetHeap
{
    t_AssetCompilationPassWidgets asset_compilation_passes;
    PoolIndexed<AssetCompilationPass::sToken> asset_compilation_passes_compilationtoken;

    inline static AssetCompilerWidgetHeap allocate()
    {
        return AssetCompilerWidgetHeap{Pool<AssetCompilationPassWidget>::allocate(0), PoolIndexed<AssetCompilationPass::sToken>::allocate_default()};
    };
    ...
    inline AssetCompilationPassWidget_Token allocate_widget(AssetCompilationPassWidget& p_widget, const AssetCompilationPass::sToken p_pass)
    {
        AssetCompilationPassWidget_Token l_token = this->asset_compilation_passes.alloc_element(p_widget);
        this->asset_compilation_passes_compilationtoken.alloc_element(p_pass);
        return l_token;
    };

    inline AssetCompilationPassWidget& get_widget(const AssetCompilationPassWidget_Token p_widget_token)
    {
        return this->asset_compilation_passes.get(p_widget_token);
    };

    inline AssetCompilationPass::sToken get_asset_compilation_pass_from_widget(const AssetCompilationPassWidget_Token p_asset_compilation_pass_widget)
    {
        return this->asset_compilation_passes_compilationtoken.get(token_build_from<PoolIndexed<AssetCompilationPass::sToken>::sTokenValue>(p_asset_compilation_pass_widget));
    };

    inline AssetCompilationPassWidget& get_widget_from_asset_compilation_pass(const AssetCompilationPass::sToken p_asset_compilation_pass_token)
    {
        return this->asset_compilation_passes.get(token_build_from<AssetCompilationPassWidget_TokenValue>(p_asset_compilation_pass_token));
    };

    inline void free_widget(const AssetCompilationPassWidget_Token p_widget_token)
    {
        this->asset_compilation_passes_compilationtoken.release_element(token_build_from<PoolIndexed<AssetCompilationPass::sToken>::sTokenValue>(p_widget_token));
...
struct AssetCompilationPassViewer
{
    ...
    struct Widgets
    {
        ...
        QListWidgetItemSelection<AssetCompilationPassWidget_Token> compilation_pass_list;
    ...
    Vector<AssetCompilationPassWidget_Token> displayed_asset_compilation_pass_widgets;
    ...
    inline void allocate(Callbacks& p_callbacks)
    {
        ...
        this->displayed_asset_compilation_pass_widgets = Vector<AssetCompilationPassWidget_Token>::allocate(0);

        QListWidgetItemSelection<AssetCompilationPassWidget_Token>::Callbacks l_compilation_passes_vector_callbacks;
    ...
    inline void add_asset_compilation_to_selection(const AssetCompilationPassWidget_Token p_compilation_pass_widget_token, const Slice<int8>& p_item_name)
    {
        QListWidgetItem* l_item = new QListWidgetItem();
    ...
    inline void remove_asset_compilation_selection(const AssetCompilationPassWidget_Token p_compilation_pass_widget_token)
    {
    ...
    inline void remove_asset_compilation_widget(const AssetCompilationPassWidget_Token p_compilation_pass_widget_token)
    {
    ...
    inline void remove_asset_compilation_widget_and_selection(const AssetCompilationPassWidget_Token p_compilation_pass_widget_token)
    {
    ...
    inline void remove_and_detach_all_asset_compilation_widgets(AssetCompilerWidgetHeap& p_asset_compiler_widget_heap)
    {
        for (loop_reverse(i, 0, this->displayed_asset_compilation_pass_widgets.Size))
        {
            AssetCompilationPassWidget_Token l_widget = this->displayed_asset_compilation_pass_widgets.get(i);
...
struct AssetCompilerWindow
{
    ...
    {
        void* closure;
        void (*load_asset_tree)(AssetCompilerWindow* p_window, Vector<AssetCompilationPass::sToken>* in_out_asset_compilation_pass, const Slice<int8>& p_file_configuration, void* p_closure);
        void (*on_go_button_pushed)(AssetCompilerWindow* p_window, void* p_closure);
    } callbacks;

    Vector<AssetCompilationPass::sToken> callbacks_asset_compilation_pass_buffer;
    ...
    {
        this->callbacks_asset_compilation_pass_buffer = Vector<AssetCompilationPass::sToken>::allocate(0);
    ...
    inline void free_compiler_passes(AssetCompilerPassHeap& p_asset_compiler_heap)
    {
        this->widget_heap.asset_compilation_passes_compilationtoken.foreach_reverse(
            [&](const PoolIndexed<AssetCompilationPass::sToken>::sToken p_token, const AssetCompilationPass::sToken p_asset_compilation_pass_token) {
                p_asset_compiler_heap.free_asset_compiler_pass(p_asset_compilation_pass_token);
                this->free_asset_compilation_widget(token_build_from<AssetCompilationPassWidget_TokenValue>(p_token));
            });
    };
    ...
    inline AssetCompilationPass::sToken free_asset_compilation_widget(const AssetCompilationPassWidget_Token p_widget_token)
    {
        AssetCompilationPass::sToken l_widget = this->widget_heap.get_asset_compilation_pass_from_widget(p_widget_token);
    ...
    inline void setup_widget_events(const Callbacks& p_callbacks, AssetCompilerPassHeap& p_asset_compiler_heap)
    {
        ...
        QObject::connect(this->widgets.feed_tree_button, &QPushButton::released, [&]() {
            ...
            QObject::connect(this->widgets.feed_tree_file_dialog, &QFileDialog::fileSelected, [&](const QString& p_file) {
                ...
                {
                    AssetCompilationPass::sToken l_pass = this->callbacks_asset_compilation_pass_buffer.get(i);
                    ...
                    AssetCompilationPassWidget_Token l_widget_token = this->widget_heap.allocate_widget(l_compilation_pass_widget, l_pass);
...
struct AssetCompilerComposition
{
    ...
    inline static void push_selected_assetcompilation_pass_to_thread(AssetCompilerWindow& p_window, AssetCompilerPassHeap& p_heap, AssetCompilationThread& p_thread)
    {
        ...
        {
            AssetCompilationPassWidget_Token l_widget_token = p_window.widgets.asset_compilation_viewer.displayed_asset_compilation_pass_widgets.get(i);
            AssetCompilationPass::sToken l_asset_compilation_pass = p_window.widget_heap.get_asset_compilation_pass_from_widget(l_widget_token);
...
struct AssetCompilerEditor
{
    ...
    inline void allocate()
    {
        ...
        l_asset_compiler_window_cb.load_asset_tree = [](AssetCompilerWindow* p_window, Vector<AssetCompilationPass::sToken>* in_out_asset_compilation_pass,
