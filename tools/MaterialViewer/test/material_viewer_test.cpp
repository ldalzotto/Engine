    ...
    QObject::connect(&l_main_loop, &QTimer::timeout, [&]() {
        ...
        else if (l_frame_count == 2)
        {
            ...
            l_material_viewer_editor.engine_runner.sync_engine_wait_for_one_whole_frame_at_end_of_frame(l_material_viewer_editor.material_viewer_engine_unit.engine_execution_unit, [&]() {
                Slice<int8> l_selected_material = Slice_int8_build_rawstr(l_material_viewer_editor.material_viewer_window.view.selected_material.toLocal8Bit().data());
                Slice<int8> l_selected_mesh = Slice_int8_build_rawstr(l_material_viewer_editor.material_viewer_window.view.slected_mesh.toLocal8Bit().data());
                Slice<int8> l_material_1_json_file = Slice_int8_build_rawstr("material_1.json");
                Slice<int8> l_shape_1_json_file = Slice_int8_build_rawstr("shape_1.obj");
                assert_true(Slice_compare(&l_selected_material, &l_material_1_json_file));
                assert_true(Slice_compare(&l_selected_mesh, &l_shape_1_json_file));
        ...
        else if (l_frame_count == 3)
        {
            l_material_viewer_editor.engine_runner.sync_engine_at_end_of_frame(l_material_viewer_editor.material_viewer_engine_unit.engine_execution_unit, [&]() {
                ...
                Slice<int8> l_selected_mesh = Slice_int8_build_rawstr(l_material_viewer_editor.material_viewer_window.view.slected_mesh.toLocal8Bit().data());
                Slice<int8> l_shape_2_file_name = Slice_int8_build_rawstr("shape_2.obj");
                assert_true(Slice_compare(&l_selected_mesh, &l_shape_2_file_name));
