...
struct HeapMemory
{
    ...
    inline Heap::t_AllocatedChunks_sToken allocate_element(const Slice<int8>* p_element_bytes)
    {
        Heap::t_AllocatedChunk_Return l_heap_allocated_element;
    ...
    inline Heap::t_AllocatedChunks_sToken allocate_empty_element(const uimax p_element_size)
    {
        Heap::t_AllocatedChunk_Return l_heap_allocated_element;
    ...
    inline Heap::t_AllocatedChunks_sToken allocate_empty_element_return_chunk(const uimax p_element_size, Slice<int8>* out_chunk)
    {
        Heap::t_AllocatedChunk_Return l_heap_allocated_element;
        this->handle_heap_allocation_state(this->_Heap.allocate_element(p_element_size, &l_heap_allocated_element));
    ...
    template <class ELementType> inline Heap::t_AllocatedChunks_sToken allocate_element_typed(const ELementType* p_element)
    {
    ...
    inline void release_element(const Heap::t_AllocatedChunks_sToken p_chunk)
    {
        this->_Heap.release_element(p_chunk);
    };

    inline Slice<int8> get(const Heap::t_AllocatedChunks_sToken p_chunk)
    {
    ...
    template <class ElementType> inline ElementType* get_typed(const Heap::t_AllocatedChunks_sToken p_chunk)
    {
