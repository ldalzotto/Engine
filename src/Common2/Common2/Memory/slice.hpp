...
template <class ElementType> struct Slice
{
    ...
    // TODO -> move these functions to an algorithm static class
    ...
    // TODO -> move these functions to an algorithm static class
    inline int8 last_index_of(const Slice<ElementType>& p_other, uimax* out_index) const
    {
        Slice<ElementType> l_comparison = *this;
        uimax tmp_index = -1;
        uimax l_current_index = -1;
        *out_index = l_current_index;
        while (l_comparison.Size != 0 && l_comparison.find(p_other, &tmp_index))
        {
    ...
    // TODO -> move these functions to an algorithm static class
    // TODO -> write test.
    inline int8 last_index_of_not_endofslice(const Slice<ElementType>& p_other, uimax* out_index) const
    {
        Slice<ElementType> l_comparison = *this;
        uimax tmp_index = -1;
        uimax l_current_index = -1;
