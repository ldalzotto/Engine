...
inline void collision_test_01()
{
    ...
    TokenT(BoxCollider) l_box_collider_1, l_box_collider_2, l_box_collider_3;
    {
    ...
    TokenT(ColliderDetector) l_box_collider_1_detector_handle = l_collision.allocate_colliderdetector(l_box_collider_1);
...
inline void collision_test_02()
{
    ...
    TokenT(ColliderDetector) l_box_collider_1_detector_handle;
    {
...
inline void collision_test_03()
{
    ...
    TokenT(ColliderDetector) l_box_collider_1_detector_handle, l_box_collider_2_detector_handle, l_box_collider_3_detector_handle;
    {
        l_box_collider_1_detector_handle = l_collision.allocate_colliderdetector(l_box_collider_1);
...
inline void collision_test_04()
{
    ...
    TokenT(BoxCollider) l_box_collider_4;
...
inline void collision_test_06()
{
    ...
    TokenT(ColliderDetector) l_box_collider_1_detector_handle, l_box_collider_2_detector_handle;
    {
        l_box_collider_1_detector_handle = l_collision.allocate_colliderdetector(l_box_collider_1);
        l_box_collider_2_detector_handle = l_collision.allocate_colliderdetector(l_box_collider_2);
    }
