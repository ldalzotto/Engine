...
{
    return TriggerEvent{tk_bdT(BoxCollider), Trigger::State::UNDEFINED};
};

inline TriggerEvent TriggerEvent::build(const TokenT(BoxCollider) p_other, const Trigger::State p_state)
{
...
{
    return CollisionHeap2{PoolIndexed<BoxCollider>::allocate_default(), Pool<TokenT(ColliderDetector)>::allocate(0), PoolIndexed<ColliderDetector>::allocate_default(),
...
inline TokenT(ColliderDetector) CollisionHeap2::allocate_colliderdetector(const TokenT(BoxCollider) p_box_collider)
{
    ...
    TokenT(ColliderDetector) l_collider_detector_token = this->collider_detectors.alloc_element(ColliderDetector::build(l_trigger_events));
    this->get_colliderdetector_from_boxcollider(p_box_collider) = l_collider_detector_token;
    return l_collider_detector_token;
};

inline void CollisionHeap2::free_colliderdetector(const TokenT(BoxCollider) p_box_collider, const TokenT(ColliderDetector) p_collider_detector){
...
{
    this->get_colliderdetector_from_boxcollider(p_box_collider) = tk_bdT(ColliderDetector);
    // this->box_colliders_to_collider_detector.release_element(token_cast_p(Token(ColliderDetector), p_box_collider));
}
}
;

inline TokenT(BoxCollider) CollisionHeap2::allocate_boxcollider(const BoxCollider& p_box_collider)
{
    TokenT(BoxCollider) l_box_collider_index = this->box_colliders.alloc_element(p_box_collider);
    this->box_colliders_to_collider_detector.alloc_element(tk_bdT(ColliderDetector));
    return l_box_collider_index;
};

inline void CollisionHeap2::push_boxcollider_transform(TokenT(BoxCollider) p_boxcollider, const transform_pa& p_world_transform)
{
    BoxCollider& l_boxcollider = this->box_colliders.get(p_boxcollider);
    l_boxcollider.transform = p_world_transform;
};

inline void CollisionHeap2::free_boxcollider(const TokenT(BoxCollider) p_box_collider)
{
    TokenT(ColliderDetector)& l_collider_detector = this->get_colliderdetector_from_boxcollider(p_box_collider);
    if (tk_neq(l_collider_detector, tk_bT(ColliderDetector, -1)))
    {
        this->free_colliderdetector(p_box_collider, l_collider_detector);
    }
    this->box_colliders.release_element(p_box_collider);
    this->box_colliders_to_collider_detector.release_element(tk_bfT(TokenT(ColliderDetector), p_box_collider));
};

inline TokenT(ColliderDetector) & CollisionHeap2::get_colliderdetector_from_boxcollider(const TokenT(BoxCollider) p_box_collider)
{
    return this->box_colliders_to_collider_detector.get(tk_bfT(TokenT(ColliderDetector), p_box_collider));
};

inline Slice<TriggerEvent> CollisionHeap2::get_triggerevents_from_boxcollider(const TokenT(BoxCollider) p_box_collider)
{
    if (this->does_boxcollider_have_colliderdetector(p_box_collider))
    {
        TokenT(ColliderDetector)& l_collider_detextor = this->get_colliderdetector_from_boxcollider(p_box_collider);
...
inline Slice<TriggerEvent> CollisionHeap2::get_triggerevents_from_colliderdetector(const TokenT(ColliderDetector) p_collider_detector)
{
    return this->collider_detectors_events_2.get_vector(this->collider_detectors.get(p_collider_detector).collision_events);
};

inline int8 CollisionHeap2::does_boxcollider_have_colliderdetector(const TokenT(BoxCollider) p_box_collider)
{
    if (!this->box_colliders_to_collider_detector.is_element_free(tk_bfT(TokenT(ColliderDetector), p_box_collider)))
    {
        if (tk_neq(this->get_colliderdetector_from_boxcollider(p_box_collider), tk_bT(ColliderDetector, -1)))
        {
            return 1;
        }
    };
...
inline CollisionDetectionStep::IntersectionEvent CollisionDetectionStep::IntersectionEvent::build(const TokenT(ColliderDetector) p_detector, const TokenT(BoxCollider) p_other)
{
...
inline CollisionDetectionStep::CollisionDetectorDeletionEvent CollisionDetectionStep::CollisionDetectorDeletionEvent::build(const TokenT(BoxCollider) p_box_collider,
                                                                                                                            const TokenT(ColliderDetector) p_collider_detector)
{
...
inline CollisionDetectionStep CollisionDetectionStep::allocate()
{
    return CollisionDetectionStep{
        Vector<TokenT(BoxCollider)>::allocate(0), Vector<TokenT(BoxCollider)>::allocate(0), Vector<TokenT(BoxCollider)>::allocate(0), Vector<CollisionDetectorDeletionEvent>::allocate(0),
...
inline void CollisionDetectionStep::push_collider_for_process(const TokenT(BoxCollider) p_moved_collider)
{
    this->in_colliders_processed.push_back_element(p_moved_collider);
};

inline void CollisionDetectionStep::push_collider_for_deletion(const TokenT(BoxCollider) p_collider)
{
    this->deleted_colliders_from_last_step.push_back_element(p_collider);
};

inline void CollisionDetectionStep::push_collider_detector_for_deletion(const TokenT(BoxCollider) p_collider, const TokenT(ColliderDetector) p_detector)
{
...
inline void CollisionDetectionStep::remove_references_to_colliderdetector(CollisionHeap2& p_collision_heap, const TokenT(ColliderDetector) p_collider_detector)
{
    vector_erase_if_2_begin(&this->is_waitingfor_trigger_stay_detector, j, l_intsersrection_event) int8 l_erased = tk_eq(l_intsersrection_event.detector, p_collider_detector);
    vector_erase_if_2_end(&this->is_waitingfor_trigger_stay_detector, j, l_erased);

    vector_erase_if_2_begin(&this->is_waitingfor_trigger_none_detector, j, l_trigger_event) int8 l_erased = tk_eq(l_trigger_event.detector, p_collider_detector);
    ...
    int8 l_erased = false;
    TokenT(ColliderDetector)& l_collider_detector = p_collision_heap.get_colliderdetector_from_boxcollider(l_disabled_collider);
    if (tk_neq(l_collider_detector, tk_bT(ColliderDetector, -1)) && tk_eq(l_collider_detector, p_collider_detector))
    {
        l_erased = true;
    }
...
inline void CollisionDetectionStep::remove_references_to_boxcollider(const TokenT(BoxCollider) p_box_collider)
{
    vector_erase_if_2_begin(&this->in_colliders_processed, j, l_collider) int8 l_erased = tk_eq(l_collider, p_box_collider);
    vector_erase_if_2_end(&this->in_colliders_processed, j, l_erased);

    vector_erase_if_2_begin(&this->is_waitingfor_trigger_stay_detector, j, l_intsersrection_event) int8 l_erased = tk_eq(l_intsersrection_event.other, p_box_collider);
    vector_erase_if_2_end(&this->is_waitingfor_trigger_stay_detector, j, l_erased);

    vector_erase_if_2_begin(&this->is_waitingfor_trigger_none_detector, j, l_trigger_event) int8 l_erased = tk_eq(l_trigger_event.other, p_box_collider);
    vector_erase_if_2_end(&this->is_waitingfor_trigger_none_detector, j, l_erased);
};
...
inline void CollisionDetectionStep::generate_exit_collision_for_collider(CollisionHeap2& p_collision_heap,
                                                                         const TokenT(BoxCollider) p_box_collider){poolindexed_foreach_token_2_begin(&p_collision_heap.box_colliders, j, l_box_collider){
    if (p_collision_heap.box_colliders.get(l_box_collider).enabled){TokenT(ColliderDetector) & l_collider_detector = p_collision_heap.get_colliderdetector_from_boxcollider(l_box_collider);
if (tk_neq(l_collider_detector, tk_bT(ColliderDetector, -1)))
{
...
inline void CollisionDetectionStep::process_deleted_colliders(CollisionHeap2& p_collision_heap)
{
    ...
    {
        TokenT(BoxCollider)& l_deleted_collider = this->deleted_colliders_from_last_step.get(i);
        TokenT(ColliderDetector)& l_collider_detector = p_collision_heap.get_colliderdetector_from_boxcollider(l_deleted_collider);
        if (tk_neq(l_collider_detector, tk_bT(ColliderDetector, -1)))
        {
    ...
    for (vector_loop(&this->deleted_colliders_from_last_step, i))
    {
        TokenT(BoxCollider)& l_disabled_box_collider_token = this->deleted_colliders_from_last_step.get(i);
...
inline void CollisionDetectionStep::process_input_colliders(CollisionHeap2& p_collision_heap)
{
    ...
    {
        TokenT(BoxCollider)& l_left_collider_token = this->in_colliders_processed.get(i);
        TokenT(ColliderDetector)& l_left_collider_detector = p_collision_heap.get_colliderdetector_from_boxcollider(l_left_collider_token);
        ...
        if (tk_neq(l_left_collider_detector, tk_bT(ColliderDetector, -1)))
        {
            ...
            if (l_left_collider.enabled)
            {
                ...
                poolindexed_foreach_token_2_begin(&p_collision_heap.box_colliders, j, l_right_collider_token);

                // Avoid self test
                if (tk_neq(l_left_collider_token, l_right_collider_token))
                {
                    BoxCollider& l_right_collider = p_collision_heap.box_colliders.get(l_right_collider_token);
                    if (l_right_collider.enabled)
                    {
                        ...
                        if (l_left_projected.overlap2(l_right_projected))
                        {
                            ...
                            TokenT(ColliderDetector)& l_right_collider_detector = p_collision_heap.get_colliderdetector_from_boxcollider(l_right_collider_token);
                            if (tk_neq(l_right_collider_detector, tk_bT(ColliderDetector, -1)))
                            {
...
inline void CollisionDetectionStep::udpate_triggerstate_from_intersectionevents(CollisionHeap2& p_collision_heap)
{
    ...
    this->enter_collision(p_collision_heap, l_intersection_event);
    vector_foreach_end();

    vector_foreach_begin(&this->currentstep_exit_intersection_events, i, l_intersection_event);
    this->exit_collision(p_collision_heap, l_intersection_event);
    vector_foreach_end();
};
...
inline void CollisionDetectionStep::set_triggerstate_matchingWith_boxcollider(CollisionHeap2& p_collision_heap, const TokenT(ColliderDetector) p_collision_detector,
                                                                              const TokenT(BoxCollider) p_matched_boxcollider, const Trigger::State p_trigger_state)
{
...
struct Collision2
{
    ...
    inline TokenT(BoxCollider) allocate_boxcollider(const aabb& p_local_box)
    {
        return this->collision_heap.allocate_boxcollider(BoxCollider::build_from_local_aabb(true, p_local_box));
    };

    inline void on_collider_moved(const TokenT(BoxCollider) p_moved_collider, const transform_pa& p_world_transform)
    {
    ...
    inline void free_collider(const TokenT(BoxCollider) p_moved_collider)
    {
        this->collision_detection_step.push_collider_for_deletion(p_moved_collider);
    };

    inline BoxCollider get_box_collider_copy(const TokenT(BoxCollider) p_box_collider)
    {
        return this->collision_heap.box_colliders.get(p_box_collider);
    };

    inline int8 is_collider_queued_for_detection(const TokenT(BoxCollider) p_box_collider)
    {
    ...
    inline Slice<TriggerEvent> get_collision_events(const TokenT(ColliderDetector) p_collider_detector)
    {
        return this->collision_heap.get_triggerevents_from_colliderdetector(p_collider_detector);
    };

    inline TokenT(ColliderDetector) allocate_colliderdetector(const TokenT(BoxCollider) p_box_collider)
    {
        return this->collision_heap.allocate_colliderdetector(p_box_collider);
    };

    inline void free_colliderdetector(const TokenT(BoxCollider) p_collider, const TokenT(ColliderDetector) p_collider_detector)
    {
