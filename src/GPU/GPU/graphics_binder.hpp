...
struct GraphicsBinder
{
  ...
  private:
    inline void _cmd_beginRenderPass2(const Slice<v4f>& p_clear_values)
    {
        ...
        Slice<TokenT(TextureGPU)> l_attachments = this->graphics_allocator.heap.renderpass_attachment_textures.get_vector(this->binded_graphics_pass->attachment_textures);
