...
{
inline static TokenT(TextureGPU) allocate_texture_gpu_for_shaderparameter(GraphicsAllocator2& p_graphics_allocator, BufferMemory& p_buffer_memory, const ImageFormat& p_base_image_format)
{
    ...
    TokenT(TextureGPU) l_texture_gpu_token = GraphicsAllocatorComposition::allocate_texturegpu_with_imagegpu(p_buffer_memory, p_graphics_allocator, l_format);
...
struct Material
{
    TokenT(Slice<ShaderParameter>) parameters;
    ...
    inline void add_buffer_host_parameter(GraphicsAllocator2& p_graphics_allocator, const ShaderLayout& p_shader_layout, const TokenT(BufferHost) p_buffer_token, const BufferHost& p_buffer)
    {
        ...
        TokenT(ShaderUniformBufferHostParameter) l_parameter =
    ...
    {
        TokenT(BufferHost) l_buffer = p_buffer_allocator.allocate_bufferhost(p_memory, BufferUsageFlag::UNIFORM);
    ...
    inline TokenT(BufferHost) get_buffer_host_parameter(GraphicsAllocator2& p_graphics_allocator, const uimax p_index)
    {
    ...
    inline void add_buffer_gpu_parameter(GraphicsAllocator2& p_graphics_allocator, const ShaderLayout& p_shader_layout, const TokenT(BufferGPU) p_buffer_gpu_token, const BufferGPU& p_buffer_gpu)
    {
        uimax l_inserted_index = this->set_index_offset + p_graphics_allocator.heap.material_parameters.get_vector(this->parameters).Size;
        ...
        TokenT(ShaderUniformBufferGPUParameter) l_shader_uniform_buffer_parameter =
    ...
    inline TokenT(BufferGPU) get_buffer_gpu_parameter(GraphicsAllocator2& p_graphics_allocator, const uimax p_index)
    {
        ShaderParameter& l_shader_parameter = p_graphics_allocator.heap.material_parameters.get_vector(this->parameters).get(this->set_index_offset + p_index);
    ...
    inline void add_texture_gpu_parameter(GraphicsAllocator2& p_graphics_allocator, const ShaderLayout& p_shader_layout, const TokenT(TextureGPU) p_texture_gpu_token, const TextureGPU& p_texture_gpu)
    {
        uimax l_inserted_index = this->set_index_offset + p_graphics_allocator.heap.material_parameters.get_vector(this->parameters).Size;
        ...
        TokenT(ShaderTextureGPUParameter) l_shader_texture_gpu_parameter =
    ...
    {
        TokenT(TextureGPU) l_texture_gpu_token = ShaderParameterBufferAllocationFunctions::allocate_texture_gpu_for_shaderparameter(p_graphics_allocator, p_buffer_memory, p_base_image_format);
    ...
    inline TokenT(TextureGPU) get_texture_gpu_parameter(GraphicsAllocator2& p_graphics_allocator, const uimax p_index)
    {
        ShaderParameter& l_shader_parameter = p_graphics_allocator.heap.material_parameters.get_vector(this->parameters).get(this->set_index_offset + p_index);
