...
namespace v2
{
	...
	*/
	struct Material
	{
		...
		inline void add_buffer_host_parameter(GraphicsAllocator2& p_graphics_allocator, const ShaderLayout& p_shader_layout, const Token(BufferHost) p_buffer_token,
				const BufferHost& p_buffer)
		{
		...
		inline void add_and_allocate_buffer_host_parameter_typed(GraphicsAllocator2& p_graphics_allocator, BufferAllocator& p_buffer_allocator, const ShaderLayout& p_shader_layout, const ElementType& p_memory)
		{
		...
		inline void add_and_allocate_texture_gpu_parameter(GraphicsAllocator2& p_graphics_allocator, BufferMemory& p_buffer_memory, const ShaderLayout& p_shader_layout, const ImageFormat& p_base_image_format, const Slice<int8>& p_memory)
		{
