...
inline void gpu_buffer_allocation()
{
    ...
    {
        uimax l_value = 20;
        BufferHost_Token l_buffer_host_token = l_buffer_memory.allocator.allocate_bufferhost(l_tested_uimax_slice.build_asint8(), BufferUsageFlag::TRANSFER_READ);
    ...
    {
        BufferGPU_Token l_buffer_gpu = l_buffer_memory.allocator.allocate_buffergpu(l_tested_uimax_slice.build_asint8().Size, BufferUsageFlag::TRANSFER_WRITE | BufferUsageFlag::TRANSFER_READ);
        ...
        BufferHost_Token l_read_buffer =
    ...
    // nothing should happen
    {
        ...
        BufferGPU_Token l_buffer_gpu = l_buffer_memory.allocator.allocate_buffergpu(l_tested_uimax_slice.build_asint8().Size, BufferUsageFlag::TRANSFER_WRITE);
        BufferReadWrite::write_to_buffergpu(l_buffer_memory.allocator, l_buffer_memory.events, l_buffer_gpu, l_tested_uimax_slice.build_asint8());
...
inline void gpu_image_allocation()
{
    ...
    // allocating and releasing a ImageHost
    {
        ...
        ImageHost_Token l_image_host_token =
    ...
    // allocating and releasing a ImageGPU
    {
        ...
        ImageGPU_Token l_image_gpu = BufferAllocatorComposition::allocate_imagegpu_and_push_creation_event(l_buffer_memory.allocator, l_buffer_memory.events, l_imageformat);
...
inline void gpu_renderpass_clear()
{
    ...
    rdoc_api->StartFrameCapture(l_gpu_context.buffer_memory.allocator.device.device, NULL);
#endif
    TextureGPU_Token l_color_texture = GraphicsAllocatorComposition::allocate_texturegpu_with_imagegpu(
    ...
    TextureGPU_Token l_depth_texture = GraphicsAllocatorComposition::allocate_texturegpu_with_imagegpu(l_gpu_context.buffer_memory, l_gpu_context.graphics_allocator,
                                                                                                        ImageFormat::build_depth_2d(v3ui{32, 32, 1}, ImageUsageFlag::SHADER_DEPTH_ATTACHMENT));

    // ImageGPU_Token l_color_image = l_gpu_context.buffer_memory.allocator.allocate_imagegpu();
    // TextureGPU_Token l_color_texture = l_gpu_context.graphics_allocator.texturegpu_allocate(l_gpu_context.buffer_memory.allocator.device, );

    GraphicsPass_Token l_graphics_pass;
    {
        GraphicsPassAllocationComposition::RenderPassAttachmentInput<2> l_renderpasss_allocation_input = {
            SliceN<TextureGPU_Token, 2>{l_color_texture, l_depth_texture}, SliceN<AttachmentType, 2>{AttachmentType::COLOR, AttachmentType::DEPTH},
    ...
    BufferHost_Token l_color_attachment_value =
...
#if 1
    GraphicsPass_Token l_not_cleared_graphics_pass;
    {
        GraphicsPassAllocationComposition::RenderPassAttachmentInput<2> l_renderpasss_allocation_input = {
            SliceN<TextureGPU_Token, 2>{l_color_texture, l_depth_texture}, SliceN<AttachmentType, 2>{AttachmentType::COLOR, AttachmentType::DEPTH},
...
inline void gpu_draw()
{
...

    {
        ...
        GraphicsPass_Token l_graphics_pass = GraphicsPassAllocationComposition::allocate_attachmentimages_then_attachmenttextures_then_renderpass_then_graphicspass<2>(
        ...
        BufferGPU_Token l_vertex_buffer = l_buffer_memory.allocator.allocate_buffergpu(slice_from_slicen(&l_vertices).build_asint8().Size,
        ...
        // BufferHost_Token l_vertex_buffer =  l_buffer_allocator.allocate_bufferhost(l_vertices_slice.build_asint8(), BufferUsageFlag::VERTEX);

        Shader_Token l_first_shader;
        ShaderLayout_Token l_first_shader_layout;
        ShaderModule_Token l_vertex_first_shader_module, l_fragment_first_shader_module;
        {
...
#version 450\n
        ...
        ShaderLayout_Token l_global_shader_layout;
        {
...
#version 450\n
        ...
        BufferHost_Token l_color_attachment_value =
            GraphicsPassReader::read_graphics_pass_attachment_to_bufferhost(l_buffer_memory, l_graphics_allocator, l_graphics_allocator.heap.graphics_pass.get(l_graphics_pass), 0);
        BufferHost_Token l_depth_attachment_value =
...
inline void gpu_draw_indexed()
{
...

    {
        ...
        BufferGPU_Token l_indices_buffer = l_buffer_memory.allocator.allocate_buffergpu(slice_from_slicen(&l_indices).build_asint8().Size, BufferUsageFlag::TRANSFER_WRITE | BufferUsageFlag::INDEX);
...
inline void gpu_texture_mapping()
{
...

    {
        ...
        /*
        TextureGPU_Token l_texture = GraphicsAllocatorComposition::allocate_texturegpu_with_imagegpu(l_buffer_allocator, l_graphics_allocator,
        ...
        ImageGPU_Token l_texture_image = l_graphics_allocator.heap.textures_gpu.get(l_texture).Image;
        */
...
inline void gpu_present()
{
    ...
    EWindow_Token l_window_token = WindowAllocator::allocate(l_window_size.x, l_window_size.y, slice_int8_build_rawstr(""));
    ...
    TextureGPU_Token l_render_target_texture = GraphicsAllocatorComposition::allocate_texturegpu_with_imagegpu(
...

    {
        ...
        ImageGPU_Token l_render_target_image = l_gpu_context.graphics_allocator.heap.textures_gpu.get(l_render_target_texture).Image;
...
inline void gpu_material_parameter_set()
{
    ...
    ShaderLayout_Token l_material_layout = l_graphics_allocator.allocate_shader_layout(l_material_layout_parameter_types, l_vertex_parameters, 0);
