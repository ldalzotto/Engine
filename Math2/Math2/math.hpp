...
#define MATH_DEFINITION
#define MATH_KERNEL
#define MATH_GEOMETRY
#define MATH_SERIALIZATION
...
{
	const m44f IDENTITY = m44f::build_columns(
...
#undef MATH_DEFINITION
#undef MATH_KERNEL
#undef MATH_GEOMETRY
#undef MATH_SERIALIZATION